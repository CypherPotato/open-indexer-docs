...
As habilidades são primariamente fornecidas através de nome e uma breve descrição do que aquela habilidade é e quando ela deve ser usada. Você pode ter várias habilidades em sua conta, mas usar somente parte delas em seu [AI Gateway](/docs/pt-br/inference/ai-gateway). As habilidades ativadas no AI Gateway são injetadas nas instruções de sistema do seu modelo e uma função adicional é adicionada no contexto.
...
- Caso seu modelo não suporte chamadas de função, considere usar um [tool handler](/docs/pt-br/inference/pipelines) para manipular chamadas de função.
...
Para entender melhor quando e como usar habilidades em comparação com outras técnicas como **RAG (Retrieval-Augmented Generation)** e **System Prompt (Instruções de Sistema)**, use as orientações desta página em conjunto com a documentação de [coleções](/docs/pt-br/rag/collections) e [pipelines](/docs/pt-br/inference/pipelines).

Veja também:
- [Prompt Engineering Guide](https://www.promptingguide.ai/)
- [Building Production-Ready RAG Applications](https://www.anthropic.com/index/building-effective-agents)
- [AI Gateway Documentation](/docs/pt-br/inference/ai-gateway)
