...
Analytics is not a conversation debugger. If you need the full prompt, response, tool calls, metadata, or error details for an inference run, use [Conversations](/docs/pt-br/platform/conversations) and [Logs](/docs/pt-br/platform/logs) when those pages are available in your workspace.
