...
Os custos de inferência dependem do provedor, do modelo utilizado e das regras comerciais do plano ativo. Para comparar diferenças entre planos, assinatura, recursos inclusos e comissão aplicável, use a [página de preços da AIVAX](https://aivax.net/pricing).

Para detalhes sobre cobrança de saldo, armazenamento e ferramentas, consulte a [página de precificação](/docs/pt-br/pricing).

## Próximos passos

- [Começando](/docs/pt-br/getting-started) — configure sua conta e faça sua primeira chamada
- [Autenticação](/docs/pt-br/authentication) — obtenha e use sua API key
- [AI Gateways](/docs/pt-br/inference/ai-gateway) — configure seu primeiro agente
- [Coleções](/docs/pt-br/rag/collections) — importe documentos para RAG
- [Ferramentas](/docs/pt-br/tools/builtin-tools) — explore as ferramentas disponíveis
