...
Channel: **privacy@aivax.net** or **wm@aivax.net** (Data Protection Officer). Standard response time: up to 15 days. We may request identity verification. For data where we act as Processor, we will direct the data subject to the Controller Account Manager.
